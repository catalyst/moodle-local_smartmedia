...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_smartmedia/usesdkcreds',
        get_string('settings:aws:usesdkcreds', 'local_smartmedia'),
        get_string('settings:aws:usesdkcreds_desc', 'local_smartmedia'),
        false
    ));

    $settings->add(new admin_setting_configtext(
        'local_smartmedia/api_key',
    ...
    $settings->add(new admin_setting_configtext(
        'local_smartmedia/s3_input_bucket',
    ...
    $settings->add(new admin_setting_configtext(
        'local_smartmedia/s3_output_bucket',
    ...
    $settings->add(new admin_setting_configtext(
        'local_smartmedia/sqs_queue_url',
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_smartmedia/lowlatency',
        get_string('settings:lowlatency', 'local_smartmedia'),
        get_string('settings:lowlatency_help', 'local_smartmedia'),
        0
    ));
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_smartmedia/quality_low',
        get_string('settings:output:quality_low', 'local_smartmedia'),
        get_string('settings:output:quality_low_help', 'local_smartmedia'),
        1
    ));

    $settings->add(new admin_setting_configcheckbox(
        'local_smartmedia/quality_medium',
        get_string('settings:output:quality_medium', 'local_smartmedia'),
        get_string('settings:output:quality_medium_help', 'local_smartmedia'),
        0
    ));

    $settings->add(new admin_setting_configcheckbox(
        'local_smartmedia/quality_high',
        get_string('settings:output:quality_high', 'local_smartmedia'),
        get_string('settings:output:quality_high_help', 'local_smartmedia'),
        1
    ));

    $settings->add(new admin_setting_configcheckbox(
        'local_smartmedia/quality_extrahigh',
        get_string('settings:output:quality_extrahigh', 'local_smartmedia'),
        get_string('settings:output:quality_extrahigh_help', 'local_smartmedia'),
        0
    ));

    $settings->add(new admin_setting_configcheckbox(
        'local_smartmedia/audio_output',
        get_string('settings:output:audio_output', 'local_smartmedia'),
        get_string('settings:output:audio_output_help', 'local_smartmedia'),
        1
    ));

    $settings->add(new admin_setting_configcheckbox(
        'local_smartmedia/download_files',
        get_string('settings:output:download_files', 'local_smartmedia'),
        get_string('settings:output:download_files_help', 'local_smartmedia'),
        1
    ));
    ...
    $settings->add(new admin_setting_configcheckbox(
        'local_smartmedia/proactiveconversion',
        get_string('settings:processing:proactiveconversion', 'local_smartmedia'),
        get_string('settings:processing:proactiveconversion_help', 'local_smartmedia'),
        0
    ));

    $settings->add(new admin_setting_configcheckbox(
        'local_smartmedia/viewconversion',
        get_string('settings:processing:viewconversion', 'local_smartmedia'),
        get_string('settings:processing:viewconversion_help', 'local_smartmedia'),
        1
    ));

    $settings->add(new admin_setting_configduration(
        'local_smartmedia/convertfrom',
        get_string('settings:processing:convertfrom', 'local_smartmedia'),
        get_string('settings:processing:convertfrom_help', 'local_smartmedia'),
        WEEKSECS,
        WEEKSECS
    ));

    $settings->add(new admin_setting_configduration(
        'local_smartmedia/maxruntime',
        get_string('settings:processing:maxruntime', 'local_smartmedia'),
        get_string('settings:processing:maxruntime_help', 'local_smartmedia'),
        5 * MINSECS,
        MINSECS
    ));
    ...
    $settings->add(new admin_setting_configexecutable(
        'local_smartmedia/pathtoffprobe',
        get_string('settings:ffprobe:pathtoffprobe', 'local_smartmedia'),
        get_string('settings:ffprobe:pathtoffprobe_desc', 'local_smartmedia'),
        '/usr/bin/ffprobe'
    ));
    ...
    $ADMIN->add('reports', new admin_externalpage(
        ...
        "$CFG->wwwroot/local/smartmedia/report.php"
    ));
}
