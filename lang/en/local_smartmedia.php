...
$string['report:files'] = 'Files';
$string['report:format'] = 'Format';
$string['report:heading'] = 'Smart Media Overview Report ({$a})';
...
$string['settings:processing:quality_low'] = ' Low quailty output';
$string['settings:processing:quality_low_help'] = 'Source file will be transcode to a low quality low bandwidth output.';
$string['settings:processing:quality_medium'] = 'Medium quality output';
$string['settings:processing:quality_medium_help'] = 'Source file will be transcode to a medium quality medium bandwidth output.';
$string['settings:processing:quality_high'] = 'High quality output';
$string['settings:processing:quality_high_help'] = 'Source file will be transcode to a high quality high bandwidth output.';
$string['settings:processing:audio_output'] = 'Audio output';
$string['settings:processing:audio_output_help'] = 'Provide an audio only output for video files.';
$string['settings:processing:download_files'] = 'Download files';
$string['settings:processing:download_files_help'] = 'Provide option for users to download files.';
