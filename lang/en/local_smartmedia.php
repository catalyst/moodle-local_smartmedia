...
$string['provision:creatingpresets'] = 'Creating mediaconvert presets';
...
$string['provision:lambdaenvupdate'] = 'Updating Lambda transcode function environment variables.';
$string['provision:lambdaresourcearn'] = 'Lambda Resource ARN: {$a}';
$string['provision:mediaconvertqueue'] = 'Media convert queue: {$a}';
$string['provision:outputbucket'] = 'Output bucket: {$a}';
$string['provision:presetscreated'] = 'Media converted presets created (or already existed and were skipped)';
...
$string['reports:legacywarning'] = 'This report may contain outdated data and pricing information due to Elastic Transcoder / MediaConvert migration';
