...
$string['report:heading'] = 'Media transcoding report - {$a} region';
$string['report:location:error:clientnotset'] = 'No aws_ets_pricing_client passed to form.';
$string['report:location:header'] = 'Select transcode region';
$string['report:location:select'] = 'Select region';
$string['report:location:submit'] = 'Set region';
